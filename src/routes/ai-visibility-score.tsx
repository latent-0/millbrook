    ...
    <>
        ...
        <Container width="narrow" className="py-24 sm:py-32">
          <Reveal>
            <div className="rounded-2xl border border-line bg-paper p-8 sm:p-10">
              <p className="font-sans text-label uppercase tracking-[0.2em] text-brass-deep">
                Definition
              </p>
          ...
          <Reveal delay={80}>
            <p className="mt-8 font-sans text-body leading-relaxed text-ink-60">
              ...
              <Reveal key={d.name} delay={i * 60}>
                ...
                >
                  <div className="sm:col-span-2">
                    ...
                    <span className="ml-1 font-sans text-label text-ink-45">pts</span>
                  </div>
                  <div className="sm:col-span-4">
                    <p className="font-sans text-label uppercase tracking-[0.16em] text-brass-deep">
                      {d.name}
                    </p>
      ...
      <section className="border-t border-line">
        <Container width="narrow" className="py-24 sm:py-32">
          <Reveal>
            ...
            <ul className="mt-8 space-y-3 font-sans text-body leading-relaxed text-ink-60">
      ...
      <section className="border-t border-line bg-canvas-2">
        <Container className="py-24 sm:py-32">
            ...
            {EXAMPLES.map((e, i) => (
              <Reveal key={e.client} delay={i * 80}>
                <div className="flex h-full flex-col rounded-2xl border border-line bg-canvas p-8">
                  ...
                  <p className="mt-3 font-sans text-label uppercase tracking-[0.16em] text-brass-deep">
                    {e.band}
                  </p>
          ...
          <Reveal delay={120}>
            <Link to="/case-studies" className="link-line mt-10 inline-block font-sans text-body">
